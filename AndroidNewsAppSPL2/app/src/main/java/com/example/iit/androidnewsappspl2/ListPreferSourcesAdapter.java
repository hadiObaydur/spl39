...
public class ListPreferSourcesAdapter extends RecyclerView.Adapter<ListPreferSourcesAdapter.ListSourceViewHolder>{
    ...
    public ListPreferSourcesAdapter(Context context, ArrayList<String> sources,int count) {
            ...
            implements View.OnClickListener
    {
        ...
        public ListSourceViewHolder(View itemView) {
            ...
            likeOrblock=(ImageView)itemView.findViewById(R.id.likeOrblock);
...
//            copy.setImageResource(R.drawable.copy);
        ...
        public void setListeners() {
            ...
            likeOrblock.setOnClickListener(ListSourceViewHolder.this);
        }
